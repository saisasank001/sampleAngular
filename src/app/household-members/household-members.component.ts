...
export class HouseholdMembersComponent implements OnInit {
  ...
  getRecordsCount(data) {
    ...
    let json = {
        ...
        state:data.state,
        is_youthful: data.is_youthful,
        lic_expired: data.lic_expired,
        street: data.street,
        apt:data.apt,
        city:data.city ,
        zip: data.zip,
...
clearAll(){
    this.householdMembersForm.reset();
    this.householdMembersForm.patchValue({
      state:"",
      is_youthful:"",
      lic_expired: "",
      street: "",
    ...
    this.getRecordsCount(this.householdMembersForm.value);
}

downloadRecords() {
    try {
        let data = this.householdMembersForm.value;
        let json = {
            // session_id: this.userService.getSessionId(),
            state:data.state,
        is_youthful: data.is_youthful,
